  ...
  return (
    <form onSubmit={submit} style={{
      ...
      <button type="submit" disabled={loading} style={{
        ...
        width: "100%", opacity: loading ? 0.6 : 1, cursor: loading ? "not-allowed" : "pointer",
      }}>
      ...
      <button
        ...
        style={{
          ...
          fontSize: 13, marginTop: 16, width: "100%", textAlign: "center", cursor: "pointer",
        }}
      >
...
export default function LoginPage() {
  return (
    <main style={{
      ...
      <Link href="/" style={{ marginBottom: 32, fontSize: 32, fontWeight: 800, letterSpacing: -1, textDecoration: "none", color: "inherit" }}>
        Iron<span style={{ color: "#7DD87A" }}>Fit</span>
      </Link>

      <Suspense fallback={<div style={{ color: "#8B9299", fontSize: 14 }}>Loading…</div>}>
        <LoginForm />
      </Suspense>
    </main>
  );
